...
int main() {
    std::ifstream inputFile("orario.txt");
    if (!inputFile) {
        std::cerr << "Errore: non posso aprire il file orario.txt" << std::endl;
        return 1;
    }
    ...
    graph->GetYaxis()->SetRangeUser(2.6e08, 4.7e08);
